...
public class SpreadsheetPanel extends JPanel{
	...
	public SpreadsheetPanel(MainFrame frMain) {
		this.frMain = frMain;
		initComponents();
	}
	...
	private void initComponents() {
		...
		popup.add(miUpload);
		popup.addSeparator();
		popup.add(miDownloadAsXls);
		popup.add(miDownloadAsPdf);
		popup.add(miDownloadAsHtml);
		popup.add(miDownloadAsOds);
		popup.add(miDownloadAsCsv);
		popup.add(miDownloadAsTsv);
		popup.addSeparator();
		popup.add(miStar);
		popup.add(miHide);
		popup.addSeparator();
		...
		miDownloadAsCsv.addActionListener(new ShowConfirmDialogAction(frMain, "download", "csv"));
		miDownloadAsHtml.addActionListener(new ShowConfirmDialogAction(frMain, "download", "html"));
		miDownloadAsOds.addActionListener(new ShowConfirmDialogAction(frMain, "download", "ods"));
		miDownloadAsPdf.addActionListener(new ShowConfirmDialogAction(frMain, "download", "pdf"));
		miDownloadAsTsv.addActionListener(new ShowConfirmDialogAction(frMain, "download", "tsv"));
		miDownloadAsXls.addActionListener(new ShowConfirmDialogAction(frMain, "download", "xls"));
	}
	...
	private JMenuItem miDownloadAsXls = new JMenuItem(LanguageResource.getStringValue("panel.pnl_spreadsheet.download_as_xls"));
	private JMenuItem miDownloadAsCsv = new JMenuItem(LanguageResource.getStringValue("panel.pnl_spreadsheet.download_as_csv"));
	private JMenuItem miDownloadAsHtml = new JMenuItem(LanguageResource.getStringValue("panel.pnl_spreadsheet.download_as_html"));
	private JMenuItem miDownloadAsOds = new JMenuItem(LanguageResource.getStringValue("panel.pnl_spreadsheet.download_as_ods"));
	private JMenuItem miDownloadAsPdf = new JMenuItem(LanguageResource.getStringValue("panel.pnl_spreadsheet.download_as_pdf"));
	private JMenuItem miDownloadAsTsv = new JMenuItem(LanguageResource.getStringValue("panel.pnl_spreadsheet.download_as_tsv"));
